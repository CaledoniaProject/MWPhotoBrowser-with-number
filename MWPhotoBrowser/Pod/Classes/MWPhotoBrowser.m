...
- (void)viewDidLoad {
    ...
    _pageLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 40, self.view.frame.size.width, 40)];
    _pageLabel.textColor = [UIColor whiteColor];
    _pageLabel.textAlignment = NSTextAlignmentCenter;
    _pageLabel.layer.zPosition = 2;
...
- (void)updateNavigation {
    ...
    _pageLabel.text = [NSString stringWithFormat:@"%ld / %ld", _currentPageIndex + 1, [self numberOfPhotos]];
